...
class LoginController extends GetxController {
  ...
  void onInit() async {
    ...
    _server.value = prefs.getString('server') ?? '120.78.200.246';
    //_server.value = prefs.getString('server') ?? '192.168.1.199';
    _sid.value = prefs.getString('room') ?? 'ion';
  }
        ...
        child: Column(
            ...
            children: <Widget>[
              SizedBox(
                width: 250,
                height: 48,
          // child: Text("wu", style: TextStyle(color: Colors.red, fontSize: 30)),
               ),
              // SizedBox(
              //     width: 250.0,
              //     height: 50.0,
              ...
              //         //         borderSide: Borde=rSide(color: Colors.black12)),
